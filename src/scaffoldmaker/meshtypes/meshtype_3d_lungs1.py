...
def generateLobeMesh(region, options, lobeid, startNodeIdentifier, startElementIdentifier, meshGroups = []):
    ...
    for n2 in range(0, elementsCountUp):
        ...
        # d21 = [sinRadiansLateral, cosRadiansLateral, 0]
        d21 = unitvectory
        nx.append(x1)
        nd1.append(d21)
        ...
        #        -0.5 * lungdepth * medialsurfcoeff * cosRadiansLateral, 0]
        # d22 = [sinRadiansLateral,-cosRadiansLateral, 0]
        d22 = unitvectory
        nx.append(x2)
        nd1.append(d22)
        ...
        #        0.5 * lungdepth * medialsurfcoeff * cosRadiansLateral, 0]
        # d23 = [sinRadiansLateral, cosRadiansLateral, 0]
        d23 = unitvectory
        nx.append(x3)
        nd1.append(d23)

        smoothedd2 = interp.smoothCubicHermiteDerivativesLine(nx, nd1, fixStartDerivative=False, fixEndDerivative=False)
        print('print derivatives for MEDIAL side= ', smoothedd2)
        ...
        nx.append(x3)
        nd1.append(d23)
        print('print nx for lateral side into interp= ', nx)

        smoothedd2 = interp.smoothCubicHermiteDerivativesLine(nx, nd1, fixStartDerivative=False, fixEndDerivative=False)
        print('print derivatives for lateral side= ', smoothedd2)
        d21 = smoothedd2[0]
        nd2.append(d21)
        d22 = smoothedd2[1]
        nd2.append(d22)
